...
def simulate_serial(nsim, nobs, ntoss, simpars):
    ...
    for s in range(0, nsim):
        ...
        # find moments
        (Moments, MomNames) = calcmom(data, means = True, stds = True, relstds = True, 
                corrs = True, autos = True, cvars = True)
    ...
    return MomentsAll, EEmatAll, elapsed, MomNames
...
# perform serial simulations
(MomentsAll, EEmatAll, elapsed, MomNames) = \
